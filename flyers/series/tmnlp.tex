...
\savebox{\pagetwo}{
  \parbox{\textwidth}{
    ...
    \begin{itemize}
    \item[$\rangle$] Reinhard Rapp (Chief Editor, Aix-Marseille Université)
    \item[$\rangle$] Silvia Hansen-Schirra (Johannes Gutenberg-Universität Mainz)
    \item[$\rangle$] Oliver Čulo (Johannes Gutenberg-Universität Mainz)
    \end{itemize}
