...
\savebox{\pagetwo}{
  \parbox{\textwidth}{
    ...
    \begin{itemize}
    \item[$\rangle$] Valentin Vydrin (Chief Editor, INALCO – LLACAN, CNRS, Paris)
    \item[$\rangle$] Larry Hyman (University of California, Berkeley)
    \item[$\rangle$] Konstantin Pozdniakov (IUF – INALCO – LLACAN, CNRS, Paris)
    \item[$\rangle$] Guillaume Segerer (LLACAN, CNRS, Paris)
    \item[$\rangle$] John Watters (SIL International, Dallas, Texas)
    \end{itemize}
