...
\setlength{\submissionfactor}{.7mm}
...
\submission{desk rejection}{lsRed}{21}
\submission{in preparation}{lsLightBlue}{73}
\submission{under review}{lsDarkBlue}{3}
\submission{rejected}{lsLightOrange}{6}
\submission{forthcoming}{lsSoftGreen}{19}
\submission{published}{lsRichGreen}{16}
...
\parbox[b][0cm][b]{0cm}{
\raisebox{0cm}{
\hspace{.7\textwidth}\tiny\color{LIGHTGRAY} Numbers as of 2015-12-31
}
}

\setlength{\tabcolsep}{0pt}
\newlength{\downloadfactor}
\setlength{\downloadfactor}{1.3mm}
...
\noindent
  \parbox{19cm}{
    \downloadbox{72}{53}{lsRichGreen}{The Alor-Pantar languages}
    \downloadbox{65}{76}{lsYellow}{Einführung in die grammatische Beschreibung des Deutschen}
    \downloadbox{50}{63}{lsDarkBlue}{New directions in corpus-based translation studies}
    \downloadbox{42}{68}{lsNightBlue}{The Talking Heads experiment}
    \downloadbox{31}{05}{lsRichGreen}{A grammar of Pite Saami}
    \downloadbox{26}{02}{lsNightGreen}{Natural causes of language}
    \downloadbox{18}{46}{lsYellow}{Grammatical theory}
    \downloadbox{18}{60}{lsRichGreen}{A typology of marked-S languages}
    \downloadbox{14}{61}{lsRichGreen}{Grammaticalization in the North}
    \downloadbox{12}{84}{black}{Thoughts on grammaticalization}
    \downloadbox{9}{47}{lsLightWine}{Prosodic detail in Neapolitan Italian}
%     \downloadbox{}{}{lsLightWine}{Linguistic variation}
%     \downloadbox{}{}{lsLightWine}{A grammar of Yakkha}
%     \downloadbox{}{}{lsLightWine}{A grammar of Mauwake}
%     \downloadbox{}{}{lsLightWine}{Language strategies for the domain of colour}
%     \downloadbox{2}{53}{lsLightWine}{Syntax und Valenz}
%     \downloadbox{1}{21}{lsLightWine}{How mobile robots can self-organise a vocabulary}
  }
} 
