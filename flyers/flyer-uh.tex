...
\noindent
\parbox{19cm}{
\begin{tabular}{p{21.06em}}\cellcolor{langscicol17}2106\\The Alor-Pantar languages\end{tabular}
\\
\begin{tabular}{p{19.51em}}\cellcolor{langscicol17}1951\\A grammar of Pite Saami\end{tabular}
\\
\begin{tabular}{p{9.88em}}\cellcolor{langscicol17} 988\\\mbox{A typology of marked-S languages}\end{tabular}
\\
\begin{tabular}{p{11.27em}}\cellcolor{langscicol20} 1127\\\mbox{Natural causes of  language}\end{tabular}
\\
\begin{tabular}{p{5.18em}}\cellcolor{langscicol11}518\\\mbox{Prosodic detail in Neapolitan Italian}\end{tabular}
}}
...
\includegraphics[width=.05\textwidth]{qrcode.eps} 
