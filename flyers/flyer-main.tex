...
\series{Research on Comparative Grammar}{rcg}{Martin Haspelmath}\vspace*{-2cm}


\newpage
\section{\sffamily\Large\bfseries Submissions}
\submission{desk rejection}{lsRed}{153}
\submission{in preparation}{lsLightBlue}{78}
\submission{under review}{lsDarkBlue}{11}
\submission{rejected}{lsLightOrange}{24}
\submission{forthcoming}{lsSoftGreen}{23}
\submission{published}{lsRichGreen}{200}
...
\parbox[b][0cm][b]{0cm}{
\raisebox{0cm}{
\hspace{.7\textwidth}\tiny\color{LIGHTGRAY} Numbers as of 2022-11-01
}
}
...
\noindent
  \parbox{19cm}{
    \downloadbox{861}{50}{lsYellow}{A aquisição de língua materna e não materna}
    \downloadbox{844}{36}{lsYellow}{Einführung in die grammatische Beschreibung des Deutschen}
    \downloadbox{692}{64}{lsYellow}{Grammatical theory}
    \downloadbox{559}{27}{lsMidWine}{African linguistics on the prairie}
    \downloadbox{554}{97}{lsYellow}{The future of dialects}
  }
} 
