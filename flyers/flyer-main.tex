...
\parbox[b][0cm][b]{0cm}{
\raisebox{0cm}{
\hspace{.7\textwidth}\tiny\color{LIGHTGRAY} Numbers as of 2017-12-31
}
}
...
\noindent
  \parbox{19cm}{
    \downloadbox{220}{84}{lsMidWine}{The future of dialects}
    \downloadbox{192}{47}{lsYellow}{Einführung in die grammatische Beschreibung des Deutschen}
    \downloadbox{145}{35}{lsYellow}{Grammatical theory}    
    \downloadbox{133}{27}{lsDarkBlue}{New directions in corpus-based translation studies}
    \downloadbox{118}{10}{lsRichGreen}{The Alor-Pantar languages}
  }
} 
...
\setlength{\itemsep}{-3pt} 
 ...
 \item[›] Friedemann Pulvermüller (Berlin)
 \item[›] Stuart Shieber (Harvard)
 \item[›] Dieter Stein (Düsseldorf)  
\end{itemize}
