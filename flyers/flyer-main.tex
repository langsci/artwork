...
\submission{desk rejection}{lsRed}{149}
\submission{in preparation}{lsLightBlue}{79}
\submission{under review}{lsDarkBlue}{10}
\submission{rejected}{lsLightOrange}{24}
\submission{forthcoming}{lsSoftGreen}{28}
\submission{published}{lsRichGreen}{189}
...
\parbox[b][0cm][b]{0cm}{
\raisebox{0cm}{
\hspace{.7\textwidth}\tiny\color{LIGHTGRAY} Numbers as of 2022-07-01
}
}
...
\noindent
  \parbox{19cm}{
    \downloadbox{828}{66}{lsYellow}{A aquisição de língua materna e não materna}
    \downloadbox{805}{57}{lsYellow}{Einführung in die grammatische Beschreibung des Deutschen}
    \downloadbox{708}{41}{lsYellow}{Grammatical theory}
    \downloadbox{541}{64}{lsMidWine}{African linguistics on the prairie}
    \downloadbox{507}{34}{lsDarkWine}{The future of dialects}
  }
} 
