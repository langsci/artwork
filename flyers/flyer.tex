...
\leftseries{Studies in Laboratory Phonology}{silp}{Martine Grice, Doris M\"ucke, Taehong Cho}
\rightseries{Textbooks in Language Sciences}{tbls}{\mbox{Stefan M\"uller, Martin Haspelmath, Claude Hag\`ege,} \mbox{Marianne Mithun, Anatol Stefanowitsch, Foong Ha Yap}}	 
 
\leftseries{\mbox{Topics at the Grammar-Discourse Interface}}{tgdi}{\mbox{Philippa Cook, Anke Holler, Cathrine Fabricius-Hansen}}
\rightseries{Translation and Multilingual Natural Language Processing}{tmnlp}{\mbox{Reinhard Rapp, Silvia Hansen-Schirra, Oliver \v{C}ulo}}
...
\noindent
\parbox{19cm}{
\begin{tabular}{p{18.69em}}\cellcolor{langscicol17}1869\\The Alor-Pantar languages\end{tabular}
\\
\begin{tabular}{p{16.72em}}\cellcolor{langscicol17}1672\\A grammar of Pite Saami\end{tabular}
\\
\begin{tabular}{p{8.79em}}\cellcolor{langscicol17} 879\\\mbox{A typology of marked-S languages}\end{tabular}
\\
\begin{tabular}{p{7.14em}}\cellcolor{langscicol20} 714\\\mbox{Natural causes of  language}\end{tabular}
\\
\begin{tabular}{p{4.18em}}\cellcolor{langscicol11}418\\\mbox{Prosodic detail in Neapolitan Italian}\end{tabular}
}}
