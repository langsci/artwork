...
\color{LIGHTGRAY}
%%\tableofcontents
\begin{tabularx}{\paperwidth}{p{.3cm}Xp{4cm}}
\vspace*{-1cm}
\hspace*{-.66cm}
...
\vspace*{-2cm}
\hspace*{-1cm}
\resizebox{4cm}{!}{\lsptable{10cm}{2.4cm}}
\end{tabularx}
...
\parbox{\textwidth}{
\sffamily
\Huge \mbox{Language Science Press}\\
...
%   \resizebox{6cm}{!}{
    ...
    \parbox{1mm}{~}
    \parbox{6mm}{\includegraphics[width=6mm]{#2.png}} 
%   }
}
...
\rightseries{Empirically Oriented Theoretical Morphology and Syntax}{eotms}{\mbox{Stefan M\"uller, Berthold Crysmann, Laura Kallmeyer}}
% \leftseries{Implemented Grammars}{eotms-ig}{Stefan M\"uller, Berthold Crysmann, Laura Kallmeyer}
\leftseries{Language Variation}{lv}{John Nerbonne, Dirk Geeraerts}

\rightseries{\mbox{Monographs on Comparative Niger-Congo}}{mcnc}{Valentin Vydrin, Larry Hyman, Konstantin Pozdniakov, \\[-.5mm]Guillaume Segerer, John Watters}
\leftseries{Morphological Investigations}{mi}{James P. Blevins, Petar Milin, Michael Ramscar}

\rightseries{Open Generative Syntax}{ogs}{Elena Anagnostopoulou, Mark Baker, Roberta \\[-.5mm]D’Alessandro, David Pesetsky, Susi Wurmbrand}
\leftseries{Phraseology and Multiword Expressions}{pmwe}{Manfred Sailer, Agata Savary}

\rightseries{Studies in Caribbean Languages}{scl}{John R. Rickford, Joseph Farquharson}
\leftseries{Studies in Diversity Linguistics}{sidl}{Martin Haspelmath, Fernando Z\'u\~niga, Peter Arkadiev,\\[-.5mm] Ruth Singer, Pilar Valenzuela}

\rightseries{Studies in Laboratory Phonology}{silp}{Martine Grice, Doris M\"ucke, Taehong Cho}
\leftseries{Textbooks in Language Sciences}{tbls}{\mbox{Stefan M\"uller, Martin Haspelmath, Claude Hag\`ege,}\\[-.5mm]  \mbox{Marianne Mithun, Anatol Stefanowitsch, Foong Ha Yap}}	 

\rightseries{\mbox{Topics at the Grammar-Discourse Interface}}{tgdi}{\mbox{Philippa Cook, Anke Holler, Cathrine Fabricius-Hansen}}
\leftseries{Translation and Multilingual Natural Language Processing}{tmnlp}{\mbox{Reinhard Rapp, Silvia Hansen-Schirra, Oliver \v{C}ulo}}
...
{\scriptsize\sffamily
\begin{tabular}{p{28mm}p{59mm}p{6mm}p{10mm}p{22mm}p{27mm}}
\cellcolor{lsRed}  &
...
\cellcolor{lsRed} \Large\centering  28 &
\cellcolor{lsLightBlue} \Large\centering 59 &  
\cellcolor{lsDarkBlue} \Large\centering 6 & 
\cellcolor{lsLightWine} \Large \centering 10 & 
\cellcolor{lsMidGreen} \Large\centering  22 & 
{\centering\cellcolor{lsRichGreen} \Large ~27 }  \\
\cellcolor{lsRed} {\rotatebox{90}{\parbox{1cm}{\Large desk\\rejection}}}   &
\cellcolor{lsLightBlue} {\rotatebox{90}{\parbox{1cm}{\Large in\\preparation}}}   &
\cellcolor{lsDarkBlue} {\rotatebox{90}{\parbox{1cm}{\Large under\,review }}} &
\cellcolor{lsLightWine} {\rotatebox{90}{\Large rejected}}   &
\cellcolor{lsMidGreen}  {\rotatebox{90}{\Large forthcoming}}   &
\cellcolor{lsRichGreen} {\rotatebox{90}{\Large published}} \\
\cellcolor{lsRed}  &
\cellcolor{lsLightBlue} &  
\cellcolor{lsDarkBlue}  & 
\cellcolor{lsLightWine} & 
...
\noindent
\parbox{19cm}{
\begin{tabular}{p{156.43em}}\cellcolor{langscicol17} 15643\\\mbox{The future of dialects}\end{tabular}
\\
\begin{tabular}{p{112.47em}}\cellcolor{langscicol17} 11247\\Einführung in die grammatische Beschreibung des Deutschen\end{tabular}
\\
\begin{tabular}{p{98.85em}}\cellcolor{langscicol17} 9885\\The Alor-Pantar languages\end{tabular}
\\
\begin{tabular}{p{90.72em}}\cellcolor{langscicol20} 9072\\\mbox{New directions in corpus based translation studies}\end{tabular}
\\
\begin{tabular}{p{82.12em}}\cellcolor{langscicol11} 8212\\\mbox{Grammatical theory}\end{tabular}
}}
% \parbox{16.72cm}{\colorbox{langscicol17}{A grammar of Pite Saami 1672}}
% 
% \parbox{8.79cm}{\colorbox{langscicol17}{A typology of Marked-S languages 879}}
% 
% \parbox{7.14cm}{\colorbox{langscicol20}{Natural causes of language 714}}
% 
% \parbox{4.18cm}{\colorbox{langscicol11}{Prosodic Detail in Neapolitan Italian 418}}
...
\parbox{.28\textwidth}{
\includegraphics[width=.25\textwidth]{qrcode.eps}
}
