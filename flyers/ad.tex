...
\includegraphics[width=2.3\textwidth]{langsci_logo_nocolor.pdf}

% \vspace*{-20mm}

%   
% \newpage
\section{\sffamily\Large\bfseries ~}
%  \raggedright
{\LARGE\bfseries\sffamily
% \LARGE
\raggedright
Language Science Press is the leading open access publisher for books in linguistics.
\begin{itemize}
\setlength{\itemsep}{-3pt}
\item[›] Excellent,  scholar-led, open
\item[›] \raggedright Free for both authors and readers\medskip

 \item[›] 26 series
 \item[›] 170+ titles
 \item[›] 1\,000+ authors
 \item[›] 1\,000\,000+ downloads
 \item[›] {www.langsci-press.org}
\end{itemize}
